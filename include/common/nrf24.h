...
/**
 * @file nrf24.h
 * @brief Nordic NRF24 definitions for ECEN 5813 -- Project 3.
 *
 * This header file contains register and bit definitions, and instruction mnemonics for
 * the Nordic NRF24 module.
 *
 * @author Kyle Harlow
